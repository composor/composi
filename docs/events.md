...
- Events
  ...
  - [Inline Events on Extended Component](#Inline-Events-on-Extended-Component)
  - [Arrow Functions for Inline Events](#Arrow-Functions-for-Inline-Events)
  - [Using handleEvent](#Using-handleEvent)
  - [handleEvent Object](#handleEvent-Object)
  - [Component Instance](#Component-Instance)
  - [handleEvent Method in Components](#handleEvent-Method-in-Components)
  - [Event Delegation with handleEvent](#Event-Delegation-with-handleEvent)
  - [Removing Event with handleEvent](#Removing-Event-with-handleEvent)
  - [Dynamically Changing handleEvent](#Dynamically-Changing-handleEvent)
  - [Event Target Gotchas](#gotchas)
  - [Using Element.closest for Event Target](#Using-Element.closest-for-Event-Target)
...
Using a `handleEvent` object when extending the Component class is the same. Like the previous example, we use the `componentDidMount` lifecycle method to add an event listener and pass it a `handleEvent` object:
...
## Using Element.closest for Event Target
