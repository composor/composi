...
export class Component {
  ...
  constructor(props) {
    ...
    if (props.render) {
      /**
       * @method {Function} render A method to convert markup into DOM nodes to inject in the document. The method itself gets provided at init time by a function provided by the user as an argument, or in the case of extending, a method defined directly on the class extension.
       */
    ...
    if (props.componentWillMount)
      /**
       * @description A method to execute a callback before the component mounts. The callback gets a reference to the component instance as its argument.
    ...
    if (props.componentDidMount)
      /**
       * @description A method to execute a callback after the component mounts. The callback gets a reference to the component instance as its argument.
       * @returns {void} undefined
       */
    ...
    if (props.componentWillUpdate)
      /**
       * @description A method to execute a callback before the component updates. The callback gets a reference to the component instance as its argument.
       * @returns {void} undefined
       */
    ...
    if (props.componentDidUpdate)
      /**
       * @description A method to execute a callback after the component updates. The callback gets a reference to the component instance as its argument.
       * @returns {void} undefined
       */
    ...
    if (props.componentWillUnmount)
      /**
       * @description A method to execute a callback before the component unmounts. The callback gets a reference to the component instance as its argument.
       * @returns {void} undefined
       */
   ...
   * @param {string | number | boolean | Object | any[] | Function} data - The data to set.
  ...
  update(data) {
    ...
    // Capture old node is component has already mounted to use with testIfVNodesDiffer:
  ...
  /**
   * @description Method to destroy a component.
   * First unbind events.
