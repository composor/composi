 ...
 */
function handleSetState(data, component) {
 ...
 * @return {void} undefined
 */
function updateComponent(data, component) {
  ...
  if (vdom && vdom.props && vdom.props.id && component.container) {
    elem =
      component.container &&
      component.container.querySelector(`#${vdom.props.id}`)
  }
...
export class Component {
  ...
  constructor(props) {
    ...
    /**
     * The base element of the component. You can use this as the base from which to perform a DOM query, or to attach an event listener to delegate events.
