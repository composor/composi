...
export class Component {
  ...
  constructor(props) {
     ...
     */
    if (this.props.beforeCreateComponent) {
      this.beforeCreateComponent = this.props.beforeCreateComponent
    }
  ...
  update(data) {
    ...
    function testIfVNodesDiffer(data) {
      if (!__oldNode) {
        ...
        if (JSON.stringify(__oldNode && __oldNode) === JSON.stringify(__render(data))) {
          return false
        } else {
          return true
        }
    ...
    if (this.mounted && testIfVNodesDiffer(_data)) {
    ...
    this.componentDidUpdate && testIfVNodesDiffer(_data) && this.componentDidUpdate(this)
  }
