...
export function updateComponent(data, component) {
  ...
  const __oldNode = component.element && component.element.node
  ...
  if (!component.mounted) {
    component.componentWillMount && component.componentWillMount(component)
    ...
    component.componentDidMount && component.componentDidMount(component)
    return
  }

  component.componentWillUpdate && component.componentWillUpdate(component)
  component.componentDidUpdate && component.componentDidUpdate(component)
}