 ...
 * @param {Node|boolean} [container] The element into which the tag will be rendered.
 * @param {Node} elementToHydrate A server-rendered element to hydrate during initial load.
